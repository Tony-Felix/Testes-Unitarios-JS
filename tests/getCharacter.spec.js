...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Testa se a função retorna o objeto correto para o parâmetro (Arya)', () => {
    ...
    expect(getCharacter('Arya')).toEqual(objeto);
  });
  ...
  it('Testa se a função retorna o objeto correto para o parâmetro Brienne', () => {
    ...
    expect(getCharacter('Brienne')).toEqual(objeto);
  })
  ...
  it('Testa se a função retorna o objeto correto para o parâmetro Melissandre', () => {
    ...
    expect(getCharacter('Melissandre')).toEqual(objeto);
  });

  it ('Testa se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
    const objeto = {
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: [ 'Not today', 'A girl has no name.' ]
  ...
  it('Testa se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('joaquim')).toBeUndefined();
  });
});
